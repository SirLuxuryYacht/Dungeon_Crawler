...
var light_damage = [40,0,0,0] #standard,fire,dark,lightning

var heavy_damage = [70,0,0,0]

var light_stamina_cost = 76

var heavy_stamina_cost = 125

var light_attack_blocker = 0.6

var heavy_attack_blocker = 0.4

var heavy_ready_time = 0.5

var ready_param = [[Vector3(0.1,0,0),Vector3(-PI/2,0,0)],[Vector3(-0.6,0,0),Vector3(0,0,0)]] #both position and rotation of the ready state of the weapon
