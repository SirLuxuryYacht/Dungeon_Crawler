...
const enemy_rotations_test = [Vector3(0,0,0),Vector3(0,0,0),Vector3(0,0,0),Vector3(0,0,0),Vector3(0,0,0),Vector3(0,0,0)]
...
const enemy_rotations_village = [Vector3(0,0,0)]
const does_respawn_village = [true]
const permanency_status_village = [true]
@onready var enemy_ids_village = fillEnemyIdList("village")

#castle_dungeon
const enemies_castle_dungeon = []
const enemy_positions_castle_dungeon = []
const enemy_rotations_castle_dungeon = []
const does_respawn_castle = []
const permanency_status_castle_dungeon = []
@onready var enemy_ids_castle_dungeon = fillEnemyIdList("castle_dungeon")

#forest
const enemies_forest = ["tree_man","tree_man"]
const enemy_positions_forest = [Vector3(-6,3,-153),Vector3(18,3,-170)]
const enemy_rotations_forest = [Vector3(0,deg_to_rad(-75),0),Vector3(0,deg_to_rad(85),0)]
const does_respawn_forest = [true,true]
const permanency_status_forest = [true,true]
...
const enemy_rotations_institute = [Vector3(0,0,0)]
...
const enemy_rotations_mountains = [Vector3(0,0,0),Vector3(0,0,0)]
...
const enemy_rotations_snowpeak = []
...
const enemy_rotations_mountain_castle = []
